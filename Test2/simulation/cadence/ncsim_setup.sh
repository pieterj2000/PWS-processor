...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/Test2_onchip_memory2_0.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog "$QSYS_SIMDIR/submodules/Test2_onchip_memory2_0.v"    -work onchip_memory2_0 -cdslib ./cds_libs/onchip_memory2_0.cds.lib
  ncvlog "$QSYS_SIMDIR/Test2.v"                                                                                                  
fi
